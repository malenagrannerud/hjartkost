      ...
      <div className="pt-6 pb-0 flex justify-center">
        <Calendar
          ...
          modifiersClassNames={{
            ...
            weight: "relative after:content-['⚖'] after:absolute after:bottom-[2px] after:left-[2px] after:text-[14px] after:leading-none after:text-blue-700",
            bloodPressure: "relative after:content-['♥'] after:absolute after:bottom-[2px] after:right-[2px] after:text-[14px] after:leading-none after:text-rose-600"
          }}
          modifiersStyles={{
            achievement: {
              fontWeight: 'bold'
