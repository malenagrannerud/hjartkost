...
const tips = [
  ...
  },
  {
    id: 7,
    title: "Salt-halt!",
    detailedInfo: "För mycket salt ökar risken för högt blodtryck. Ät max 6 gram salt per dag - det motsvarar en tesked. Använd joderat salt och undvik att salta för mycket. Färdiglagad mat innehåller ofta mycket salt.",
    category: "Livsmedelsverket",
    color: "bg-orange-100",
    textColor: "text-blue-900",
    healthScore: 4
...

  {
    ...
    detailedInfo: "Bönor, linser, ärtor och kikärtor innehåller protein, fibrer, vitaminer och mineraler. De är klimatsmarta alternativ till kött och fungerar utmärkt i grytor, soppor, sallader och köttfärsblandningar. Baljväxter mättar bra och är dessutom prisvärda. Både torkade och konserverade varianter är bra.",
    category: "Livsmedelsverket",
    color: "bg-green-100",
    textColor: "text-blue-900",
    healthScore: 3
