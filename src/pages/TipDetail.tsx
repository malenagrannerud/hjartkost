...
const TipDetail = () => {
  ...
  return (
    <div className={`min-h-screen ${tip.color} p-6 pb-24`}>
      <button
        onClick={() => navigate(-1)}
        className={`flex items-center gap-2 ${tip.textColor} mb-6 hover:opacity-70 transition-opacity`}
      >
        <ArrowLeft size={24} />
      ...
      <div className="space-y-6">
        <h1 className={`text-3xl font-bold ${tip.textColor}`}>{tip.title}</h1>
